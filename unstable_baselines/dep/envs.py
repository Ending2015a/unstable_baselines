...
from unstable_baselines.lib.utils import (stack_obs,
                                        StateObject)
...
class SubprocVecEnv():
    ...
    def step_wait(self):
        ...
        return stack_obs(obs, self.observation_space), np.stack(rews), np.stack(dones), infos
    ...
    def reset(self):
        ...
        return stack_obs(obs, self.observation_space)
