...
python -m unstable_baselines.td3.run \
            --rank $rank --seed $seed --logdir='./log/{env_id}/td3/{rank}' --logging='training.log' \
            ...
            --batch_size=100 --verbose=2 --lr=1e-3 --explore_noise --record_video